...
models (GLMMs). It is based on `lme4` [@lme4], but with 
with more choices for the type of approximation to the likelihood used,
and an extended interface
...
[@Ogden2015]. 
 There are two parameters which control the sequential reduction
approximation. 
