...
to allow easy fitting of a wider range of models. At the moment, the sequential reduction approximation is not used. This document explains how to use the
subformula interface, demonstrated with some examples from the `BradleyTerry2`
...
2. `...` contains a **subformula** for each substituted variable, which
