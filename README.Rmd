...
the the Laplace and adaptive Gaussian quadrature approximations,
...
The vignette provides more information about the different
approximations.
...
You can install this development version of `glmmsr` 
by running
```{r, eval = FALSE}
